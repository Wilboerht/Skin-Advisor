...
function initVertexMap() {
    ...
    // 已移除与眼周/鼻梁/T区重叠的点 (如 151, 153, 154, 155, 133, 7, 33...)
    const foreheadIndices = [
        10, 338, 297, 332, 284, 251, 389, 356,
        54, 103, 67, 109,
        // Upper Forehead & Temples
        63, 105, 66, 107, 55, 193, 245, 124, 46, 53, 52, 65,
        333, 296, 334, 293, 300, 298,
        // Mid Forehead
        68, 69, 70, 71, 21 // 21 is low forehead / glabella top
    ];
    // 填充更密集的内部点
    const foreheadDense = [
        104, 108,
    ...
    const leftCheekIndices = [
        ...
        // 鼻唇沟 (Nasolabial Left) - 移除额头点 63, 105, 66, 107
    ...
    const rightCheekDense = [
        ...
        // 补充密集点 (移除 Jawline 重叠点: 152, 377, 400 等)
        454, 323, 361, 288,
        // 更多内部填充
    ...
    const jawlineIndices = [
        ...
        // 下巴区域 (Mentum) - 移除鼻梁/T区点 (14-18, 200, 199, 175)
