...
export const FOCUS_PROBLEM_ENTRIES: FocusProblemEntry[] = [
    {
        ...
        solutions: {
            skincare: [
                "每周 1-2 次温和乳酸类焕肤，提亮肤质",
                "使用含维生素 C 衍生物（如 AA2G）的精华抗氧化提亮",
                "加强保湿，充盈角质层提升通透感",
            ],
    ...
    },
    {
        ...
        solutions: {
            skincare: [
                "使用含烟酰胺或维生素 E（生育酚）的眼部产品，配合按摩促循环",
                "睡前热敷眼周，晨起冷敷消浮肿",
                "严格防晒并佩戴墨镜，防止眼周色素加深",
            ],
    ...
    },
    {
        ...
        solutions: {
            skincare: [
                "使用含玻色因或胜肽（如乙酰基六肽-8）的抗老产品，长期坚持使用",
                "做好基础保湿与防晒，减缓胶原流失",
                "配合面部按摩放松表情肌，减少表情纹加深",
            ],
    ...
    },
    {
        ...
        solutions: {
            ...
            diet: ["多吃富含维生素 C 与番茄红素的果蔬（如番茄），辅助抗氧化"],
