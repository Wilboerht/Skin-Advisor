...
async function generateAvatarImage(
  ...
  const prompt = isMale
    ? `水彩手绘风格男性胸像，头顶预留一定空间。清新治愈，画面构图简洁，主体人物置身于纯白背景中，视觉焦点突出。沉稳质感风成熟男士，短发整齐利落，眉眼温和有故事感，有着灰绿色的明亮眼眸，有着浅杏色腮红与粉嫩唇色，妆容清透自然，气质沉稳儒雅。微微侧身，单手轻扶领口，姿态从容大气，穿着简约深色针织衫，质感柔和。头发以水彩平涂+一些勾线为主；不同区域的勾线的颜色有区分，面部和手部轮廓为暖咖色，颜色明度浅一些（色号#BD9589）；嘴部勾线为较深的红色（色号#9E5453）；衣服没有外轮廓线，是水彩平涂的形式，保留水彩肌理，衣服区域内部有白色的细线条作为对一些细节的交代。整幅画以低饱和度的柔和色调为主，结合通透的水彩笔触与简约的概括性线条，营造出清新恬静、治愈舒适的视觉氛围，画面松弛、灵动，是极具氛围感的日系清新插画作品，比例 「1:1」`
    : `水彩手绘风格女性胸像，头顶预留一定空间。清新治愈，画面构图简洁，主体人物置身于纯白背景中，视觉焦点突出。温柔优雅的女性，长发自然垂落，眉眼柔和有灵气，有着明亮的琥珀色眼眸，有着浅杏色腮红与粉嫩唇色，妆容清透自然，气质温婉知性。微微侧身，单手轻触发梢，姿态优雅从容，穿着简约浅色针织衫，质感柔和。头发以水彩平涂+一些勾线为主；不同区域的勾线的颜色有区分，面部和手部轮廓为暖咖色，颜色明度浅一些（色号#BD9589）；嘴部勾线为较深的红色（色号#9E5453）；衣服没有外轮廓线，是水彩平涂的形式，保留水彩肌理，衣服区域内部有白色的细线条作为对一些细节的交代。整幅画以低饱和度的柔和色调为主，结合通透的水彩笔触与简约的概括性线条，营造出清新恬静、治愈舒适的视觉氛围，画面松弛、灵动，是极具氛围感的日系清新插画作品，比例 「1:1」`;
