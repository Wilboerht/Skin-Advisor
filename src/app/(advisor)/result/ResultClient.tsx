                        ...
                        <div className="max-w-[1440px] mx-auto px-6">
                            ...
                            <div className="flex justify-center mb-10 gap-4">
                                <button
                                    ...
                                    className="glass-premium-primary animate-float-premium group relative inline-flex items-center justify-center gap-2 sm:gap-3 px-5 py-2.5 sm:px-10 sm:py-3.5 rounded-full text-[12px] sm:text-[15px] tracking-[0.15em] font-medium disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer transition-all duration-300"
                                >
