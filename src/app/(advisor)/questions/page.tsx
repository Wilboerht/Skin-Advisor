            ...
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <div className="relative flex items-center justify-center py-5 md:py-7 px-6 md:px-12 lg:px-20 border-b border-[#3D4430]/5">
                        <button
                            onClick={() => router.push("/")}
                            className="absolute left-6 md:left-12 lg:left-20 px-3 py-2 flex items-center gap-1.5 text-[#3D4430]/70 hover:text-[#3D4430] transition-colors rounded-md hover:bg-[#3D4430]/5"
                            aria-label="回首页"
                        >
                        ...
                        <button
                            onClick={() => router.push("/")}
                            className="absolute right-6 md:right-12 lg:right-20 px-3 py-2 flex items-center gap-1.5 text-[#3D4430]/70 hover:text-[#3D4430] transition-colors rounded-md hover:bg-[#3D4430]/5"
                            aria-label="回到首页"
                        >
        ...
        <div className="h-screen overflow-hidden flex flex-col bg-[#F5F2E9] text-[#1A1A1A]">
            ...
            <div className="relative flex items-center justify-center py-5 md:py-7 px-6 md:px-12 lg:px-20 z-20 shrink-0 border-b border-[#3D4430]/5">
                <button
                    onClick={handleBack}
                    className={cn(
                        "absolute left-6 md:left-12 lg:left-20 px-3 py-2 flex items-center gap-1.5 text-[#3D4430]/70 hover:text-[#3D4430] transition-colors rounded-md hover:bg-[#3D4430]/5",
