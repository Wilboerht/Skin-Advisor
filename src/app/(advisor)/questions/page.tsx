...
export default function QuestionsPage() {
    ...
    if (!gender) {
        return (
            <AnimatePresence mode="wait">
                ...
                >
                    {/* Top Bar */}
                    <div className="relative flex items-center justify-center py-7 md:py-7 px-4 md:px-12 lg:px-20 border-b border-[#3D4430]/5">
                        <button
                            onClick={() => router.push("/")}
    ...
    return (
        <div className="h-dvh overflow-hidden flex flex-col bg-[#F5F2E9] text-[#1A1A1A]">
            ...
            <div className="relative flex items-center justify-center py-7 md:py-7 px-4 md:px-12 lg:px-20 z-20 shrink-0 border-b border-[#3D4430]/5">
                <button
                    onClick={handleBack}
                    className={cn(
