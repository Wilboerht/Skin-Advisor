...
const faqs: { question: string; answer: string }[] = [
  ...
  },
  {
    question: "如何进行面部扫描？",
    answer:
      "进入首页点击「开始测试」，按照提示用手机或电脑摄像头拍摄正面自拍照片。建议在自然光下拍摄，不化浓妆，不戴眼镜，确保面部光线均匀。AI 会自动检测 68 个面部特征点进行分析。如果不想拍照，也可以选择「跳过扫描」使用纯问卷模式。",
  },
  {
    question: "上传的照片会被保存吗？",
    answer:
  ...
  },
  {
    ...
    answer:
      "支持。你可以在不注册账号的情况下完成肤质测试并查看结果。匿名用户每天有 10 次免费测试次数。注册登录后可以保存历史报告、查看皮肤变化趋势、订阅护肤提醒等更多功能。",
  },
  {
  ...
  },
  {
    question: "测试次数有限制吗？",
    answer:
      "每个用户每天有 10 次免费测试次数。超过限制后需要等到第二天重置。我们建议在皮肤状态发生明显变化时（如换季、更换护肤品后）重新测试，以获得最新的肤质分析结果。",
  },
  {
