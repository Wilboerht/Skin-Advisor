...
export default function ServicesPage() {
  return (
    <main className="relative flex flex-col min-h-screen text-[#1A1A1A] bg-[#F8F7F3]">
      ...
      <section className="flex-1 flex flex-col justify-center pt-24 md:pt-20 pb-16 md:pb-6 px-6 md:px-12 lg:px-20">
        <div className="w-full max-w-5xl mx-auto text-center">
          ...
          <div className="mb-10 md:mb-[80px]">
            ...
            <h1 className="text-xl md:text-3xl font-serif text-[#1A1A1A] mb-3 md:mb-4 leading-tight tracking-tight">
              通过专业顾问评估
              <br />
              更好地了解你的肌肤
            </h1>
            <p className="text-sm md:text-base text-[#5E5E5E] font-light leading-snug max-w-2xl mx-auto mb-4 md:mb-5">
              NIHPLOD 专属护肤顾问将结合你的 AI 测肤结果、日常习惯与护肤目标，提供一对一深度评估与长期陪伴。
            </p>
          </div>

          {/* Main Content */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-6 lg:gap-8 items-start mb-10 md:mb-[80px]">
            {/* Benefits */}
            ...
            <div className="flex flex-col items-center md:items-end order-3">
              <div className="flex flex-col items-center">
                <div className="relative w-32 h-32 md:w-44 md:h-44 rounded-2xl overflow-hidden border border-[#1B3A5C]/10 bg-white p-3 md:p-4 shadow-sm">
                  <Image
