...
#   保湿修护：透明质酸钠、神经酰胺、角鲨烷、甘油、甜菜碱、泛醇、依克多因、尿囊素
#   提亮抗氧：烟酰胺、α-熊果苷、光甘草定、生育酚(VE)
#   抗老紧致：玻色因、多肽、植物鞘氨醇
#   控油祛痘：壬二酸、乳酸(低浓度)、粉防己提取物
#   舒缓退红：积雪草、红没药醇、马齿苋提取物、甘草酸二钾
# 评分标准：85-100优秀, 70-84良好, 55-69一般, 40-54需关注, <40差。
# recommendations 必须逐条针对具体的维度，每条包含：针对的问题+推荐成分+使用频率。至少输出4条，最多5条。推荐成分同样必须在上方品牌成分体系内选择。示例格式："T区出油较明显，建议每日晨间使用含水杨酸的洁面产品，每周2次泥膜深度清洁，控制油脂分泌预防粉刺形成"
# 多视角综合评估。保持专业、温和。
`;
...
3. 若孕期，在品牌成分体系基础上进一步排除以下成分（即使品牌配方中含也必须跳过该产品）：
   ...
   ✅ 孕期安全可用：壬二酸、烟酰胺、透明质酸钠、神经酰胺、角鲨烷、泛醇、玻色因、积雪草、红没药醇、甘油、甜菜碱、α-熊果苷、光甘草定、依克多因、多肽
