            ...
            <div className="text-center mb-6">
                <h3 className="text-[17px] sm:text-lg lg:text-2xl font-bold text-[#3d2f25] tracking-wide mb-2">
                    <span className="relative inline-block">
                        联系您的专属顾问，获取更多专属护肤建议
                        <span className="hidden sm:inline-flex absolute top-1/2 left-full -translate-y-1/2 ml-2 items-center rounded-full border border-[#C9A86C]/50 bg-[#C9A86C]/15 px-2.5 py-0.5 text-[10px] font-bold tracking-[0.14em] text-[#8c6b3f] leading-none whitespace-nowrap">
                            FREE
                        </span>
                    </span>
                </h3>
                <p className="text-xs lg:text-sm text-[#8c7a6b] flex items-center justify-center gap-1.5">
                    <span className="sm:hidden inline-flex items-center rounded-full border border-[#C9A86C]/50 bg-[#C9A86C]/15 px-2 py-0.5 text-[9px] font-bold tracking-[0.14em] text-[#8c6b3f] leading-none whitespace-nowrap shrink-0">
                        FREE
                    </span>
                    三步让 AI 护肤顾问读懂你的专属报告
                </p>
