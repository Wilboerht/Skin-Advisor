    ...
    return (
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    {/* ---- App Bar / Header ---- */}
                    <header className="fixed top-0 left-0 right-0 z-[330] flex items-center justify-center px-6 md:px-12 lg:px-20 py-8 md:py-7 bg-[#FAF8F5]/95 backdrop-blur-sm border-b border-[#1A1A1A]/5">
                        <button
                            onClick={handleClose}
