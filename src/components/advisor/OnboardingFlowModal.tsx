                                    ...
                                    <div className="bg-[#FDFBF7]/50 rounded-2xl p-6 mb-8 border border-[#3D4430]/5 text-left">
                                        <label className="flex items-start gap-3 cursor-pointer group">
                                            ...
                                            <span className="text-[13px] text-[#5E5E5E] leading-relaxed font-light select-none">
                                                ...
                                                <a href="https://demo.nihplod.cn/privacy" target="_blank" rel="noopener noreferrer" className="text-[#3D4430] font-medium underline underline-offset-4 mx-1">隐私政策</a>
                                                与
                                                <a href="https://demo.nihplod.cn/terms" target="_blank" rel="noopener noreferrer" className="text-[#3D4430] font-medium underline underline-offset-4 mx-1">服务条款</a>。
                                            </span>
                                        </label>
                                    </div>
