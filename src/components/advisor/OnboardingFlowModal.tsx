    ...
    return (
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    {/* ---- App Bar / Header ---- */}
                    <header className="fixed top-0 left-0 right-0 z-[100003] flex items-center justify-between px-6 md:px-12 lg:px-20 py-7 md:py-7 bg-[#FDFBF7]/95 backdrop-blur-sm border-b border-[#1A1A1A]/5">
                        <button
                            onClick={onClose}
