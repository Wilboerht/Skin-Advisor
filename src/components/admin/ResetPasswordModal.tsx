      ...
      <form onSubmit={handleSubmit}>
        <div className="relative mb-6">
          <input
            ...
            className="block w-full rounded-xl border-slate-200 bg-white/50 py-2.5 px-4 pr-10 text-sm text-slate-900 placeholder:text-slate-400 focus:bg-white focus:border-slate-400 focus:ring-0 transition-all"
          />
          <button
            type="button"
