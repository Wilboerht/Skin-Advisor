...
<div className="relative w-full max-w-[280px] mx-auto lg:max-w-xs aspect-[3/4] lg:ml-auto">
      ...
      {/* Advantages */}
      <section className="relative overflow-hidden py-14 md:py-28 px-6 md:px-12 lg:px-20 bg-white">
        <Threads
      ...
      {/* Skincare Formula */}
      <section className="py-14 md:py-28 px-6 md:px-12 lg:px-20 bg-[#F8F7F3]">
