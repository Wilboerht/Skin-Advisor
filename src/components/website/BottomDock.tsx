...
export function BottomDock() {
  ...
  const tabClass = (active: boolean) =>
    `flex flex-col items-center justify-center gap-1 flex-1 min-w-[48px] min-h-[48px] rounded-xl text-[10px] tracking-[0.05em] transition-colors duration-300 motion-reduce:transition-none focus-visible:outline-none focus-visible:bg-brand-charcoal/5 ${
      active
        ? "text-brand-charcoal"
